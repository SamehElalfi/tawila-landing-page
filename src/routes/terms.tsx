        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              By accessing and using Tawila's restaurant management platform and
            ...
            <p className="text-gray-600 mb-6">
              Tawila provides a comprehensive restaurant operating system
              including online ordering, table management, inventory tracking,
              analytics, point-of-sale systems, and related services. We reserve
            ...
            <ul className="list-disc list-inside text-gray-600 mb-6 space-y-2">
              ...
              <li>
                Be at least 18 years old and legally able to enter into
                contracts
              </li>
              <li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              according to the pricing plan you select. All fees are
              non-refundable unless otherwise stated. We reserve the right to
              change our pricing with 30 days' notice. Failure to pay fees may
              result in suspension or termination of your account. You are
              responsible for all taxes associated with your use of the
              Services.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              ...
              are owned by Tawila and are protected by international copyright,
              trademark, patent, trade secret, and other intellectual property
              laws. You are granted a limited, non-exclusive, non-transferable
              license to use the Services for your business purposes. You may
            ...
            <p className="text-gray-600 mb-6">
              You retain ownership of any content and data you upload to the
              Services ("User Content"). By uploading User Content, you grant us
              a worldwide, non-exclusive, royalty-free license to use, store,
              and process your User Content solely to provide and improve the
              Services. You represent that you have all necessary rights to your
            ...
            <p className="text-gray-600 mb-6">
              ...
              absolute security. Our use of your personal information is
              governed by our Privacy Policy. You are responsible for
              maintaining the security of your account and for backing up your
              data.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              While we strive to provide reliable and uninterrupted service, we
              do not guarantee that the Services will be available at all times
              or error-free. We may perform maintenance, updates, or
              modifications that temporarily affect service availability. We are
              not liable for any downtime, data loss, or business interruption.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              ...
              privacy practices, or availability of third-party services. Your
            ...
            <p className="text-gray-600 mb-6">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, TAWILA SHALL NOT BE LIABLE
              FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE
              DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED
              DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR
              OTHER INTANGIBLE LOSSES, RESULTING FROM: (A) YOUR USE OR INABILITY
              TO USE THE SERVICES; (B) UNAUTHORIZED ACCESS TO OR ALTERATION OF
              YOUR DATA; (C) ANY THIRD-PARTY CONDUCT OR CONTENT; OR (D) ANY
              OTHER MATTER RELATING TO THE SERVICES. OUR TOTAL LIABILITY SHALL
            ...
            <p className="text-gray-600 mb-6">
              You agree to indemnify, defend, and hold harmless Tawila, its
              ...
              with your use of the Services, your User Content, or your
            ...
            <p className="text-gray-600 mb-6">
              ...
              support team. We may suspend or terminate your access to the
              ...
              right to use the Services will immediately cease. We may retain
              your data as required by law or for legitimate business purposes.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              ...
              the rules of [Arbitration Association]. You agree to waive your
              right to participate in class actions. The arbitration shall take
              place in [Location], and judgment on the award may be entered in
            ...
            <p className="text-gray-600 mb-6">
              ...
              the courts located in [Location] for any legal proceedings.
            </p>
            ...
            <p className="text-gray-600 mb-6">
              These Terms constitute the entire agreement between you and Tawila
              regarding the Services. If any provision is found to be
              ...
              waiver. You may not assign or transfer these Terms without our
              written consent. We may assign these Terms to any affiliate or in

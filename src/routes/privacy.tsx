        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Welcome to Tawila ("we," "our," or "us"). We are committed to protecting your personal
              information and your right to privacy. This Privacy Policy explains how we collect, use,
              disclose, and safeguard your information when you use our restaurant management platform
              and services.
            </p>
            ...
            <ul className="list-disc list-inside text-gray-600 mb-6 space-y-2">
              ...
              <li>Customer data (order history, preferences, contact information)</li>
            ...
            <ul className="list-disc list-inside text-gray-600 mb-6 space-y-2">
              <li>Service providers who assist in our operations (cloud hosting, payment processing, analytics)</li>
            ...
            <p className="text-gray-600 mb-6">
              ...
              measures include encryption, secure servers, regular security assessments, and access controls.
            ...
            <p className="text-gray-600 mb-6">
              ...
              services. You can control cookies through your browser settings. However, disabling cookies may
